...
/*
LCD_RS(D/C) PD13 high/low
LCD_CS PC6 falling edge
LCD_WR PD14 falling edge
LCD_RD PD15 falling edge
*/

static void LCD_WR_REG(uint16_t LCD_Reg)
{
  // GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
  GPIO_ResetBits(GPIOD, GPIO_Pin_13); // RS
  GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS
  GPIO_ResetBits(GPIOD, GPIO_Pin_14); //WR
  GPIO_SetBits(GPIOD, GPIO_Pin_15); // RD
...
{
  // GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
  GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS
  GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS
  GPIO_ResetBits(GPIOD, GPIO_Pin_14); //WR
  GPIO_SetBits(GPIOD, GPIO_Pin_15); // RD
